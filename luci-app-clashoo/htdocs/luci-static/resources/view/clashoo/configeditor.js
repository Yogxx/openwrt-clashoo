...
return view.extend({
    ...
    tinyFmUrls: [
        '/tinyfm/tinyfm.php?p=etc%2Fclashoo',
        '/tinyfm/TinyFM.php?p=etc%2Fclashoo',
        '/tinyfm/index.php?p=etc%2Fclashoo',
        '/tinyfilemanager/tinyfilemanager.php?p=etc%2Fclashoo',
        '/tinyfilemanager/index.php?p=etc%2Fclashoo'
    ],
